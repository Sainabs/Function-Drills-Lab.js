...
let compareNums2=(compareNums(7,7))
...
//let StringToNum=+add;
let addednumber=add(3,"4")
console.log(addednumber)

// function add(a, b){
//   return(Number(a) + Number(b))
// }
// add('9','5') // call the function using strings
// let sum = add('9','8')
// console.log(sum)
////////////////// PROBLEM 7 ////////////////////
...
/*
  ...
  return 'Cool name, NAMEPARAM' (with NAMEPARAM being 
...
let nameGreeting=(nameCheck('Aisha'))
console.log(nameGreeting)
////////////////// PROBLEM 11 ////////////////////
/*
  Write a function called faveColorFinder that takes in 
  one parameter called color (which will be a string).
...
let colorRating =(faveColorFinder("gold"))
...
//CODE HERE
function theEliminator(arr){
for(let i=0;i<arr.length;i++){
  if (contestants[i]===loser){
    contestants.splice(i, 1) // i = the index to begin, 1 = how many items to remove
  }
return (contestants)//new contestants } let newContestants = theEliminator(contestants, loser) 
}
}
...
/*
  Write a function that takes in one argument, a string.
   The function should then console.log that string, 
...
/*
  ...
  Create a variable called `totalFrogs` and 
  set it equal to your function invoked, passing in the amount of gold you are willing to spend.
*/
...
let totalFrogs = buyChocolateFrogs(98)
...
let totalFrogs2 = buyChocolateFrogs2(98)
...
/*
  ...
  is in ascending order. The function should return true, 
...
/*
  There are 4 variables above: duck, rubberDuck, 
  sailorDuck and realDuck. All within different scopes.
  Given the functions and variables above, edit the arrays below 
  to contain only the appropriate variable names (as strings).
*/

//This array should contain the variable names (as strings)
// accessible in the global scope.
let globalScope = ['duck']

//This array should contain the variable names (as strings) 
//accessible in the bathroom function.
let bathroomScope = ['duck', 'rubberDuck']

//This array should contain the variable names (as strings)
// accessible in the bathtub function.
let bathtubScope = ['duck', 'rubberDuck', 'sailorDuck']

//This array should contain the variable names (as strings) 
//accessible in the pond function.
